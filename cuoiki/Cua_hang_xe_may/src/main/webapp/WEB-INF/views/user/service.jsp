 <%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <!-- Page Header Start -->
    <div class="container-fluid page-header mt-3">
        <h1 class="display-3 text-uppercase text-white mb-3">Dịch Vụ</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="">Trang chủ</a></h6>
            <h6 class="text-body m-0 px-3">/</h6>
            <h6 class="text-uppercase text-body m-0">Dịch Vụ</h6>
        </div>
    </div>
    <!-- Page Header Start -->
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <p class="m-0">Cửa hàng thường cung cấp phụ kiện và phụ tùng cho các loại xe khác nhau.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
        ...
        <div class="container py-1">
            <div class="owl-carousel vendor-carousel">
                <div class="bg-light p-4">
                    <img src="../Image/Honda/logo-vinfast.png" alt="">
                </div>
                <div class="bg-light p-4">
                    <img src="../Image/Honda/suzuki.png" alt="">
                </div>
                <div class="bg-light p-4">
                    <img src="../Image/Honda/logo_ducati.png" alt="">
                </div>
                <div class="bg-light p-4">
                    <img src="../Image/Honda/yamaha.png" alt="">
                </div>
                <div class="bg-light p-4">
                    <img src="../Image/Honda/piago.png" alt="">
                </div>
                <div class="bg-light p-4">
