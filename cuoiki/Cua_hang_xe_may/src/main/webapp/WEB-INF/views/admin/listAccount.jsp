                                 ...
                                 <td><img src="../../dist/img/avatar3.png" alt="" style="width: 50px;"></td>
                                  ...
                                  <td class="text-center">
                                    <div class="icheck-success d-inline">
                                        <a href='${pageContext.request.contextPath}/admin/accountList?action=setStatus&username=<%=a.getUsername()%>' class="btn btn-success">Đã Xác Minh</a>
                                    </div>
                                 </td>
                                 <% } else { %>
                                   <td class="text-center">
                                   <div class="icheck-success d-inline">
                                        <a href='${pageContext.request.contextPath}/admin/accountList?action=setStatus&username=<%=a.getUsername()%>' class="btn btn-danger">Chưa Xác Minh</a>
                                    </div>
                                 </td>
                                  <% } %>
